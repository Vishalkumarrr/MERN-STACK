        ...
        <>
           <Typography>{product.title.longTitle}</Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Get extra 13% off (price incluusive of discount) T&C</Typography>
                ...
                <Typography><StyledBadge/>5% Caseback on Flipkart Axis Bank Card</Typography>
                <Typography><StyledBadge/>No Case EMI on Bajaj Finserv EMI Card value above ₹2999 T&C </Typography>
            </SmallText>
            <Table>
                <TableBody>
                <ColumnText>
