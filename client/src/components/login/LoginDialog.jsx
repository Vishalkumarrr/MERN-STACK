...
const accountIntitialvalues = {
    ...
    signup: {
        view: 'signup',
        heading: "Looks like you're new herel",
        subHeading: 'Sign up with your mobile number to get startted'
    }
}
                ...
                </Image>
            {
                ...
                <Wrapper>
                  ...
                  { error && <Error>Please enter valid username or password</Error> }
                   ...
                   <LoginButton sx={boxSx} onClick={() => loginUser()}>Login</LoginButton>
                   <Typography style={{ textAlign: 'center'}}>OR</Typography>
                   <RequestOTP>Request OTP</RequestOTP>
                   <CreateAccount sx={boxSx1} onClick={() => toggleSignup()}>New to Flipkart? create an account</CreateAccount>
                </Wrapper>
            :
                <Wrapper>
                  ...
                  <LoginButton sx={boxSx} onClick={() => signupUser()}>Continue</LoginButton>
                </Wrapper>
            }        
             </Box>
        </Component>
